(function (root, factory) {
  ...
  function getY(minValue, maxValue, offsetY, height, index) {
    try {
      ...
      console.error("Error in getY function:", error);
    }
  }
  ...
  function drawDot(radius, x1, x2, color, line, x, y) {
    try {
      ...
      console.error("Error in drawDot function:", error);
    }
  }
  ...
  function drawLine(x1, x2, style, x, y) {
    try {
      ...
      console.error("Error in drawLine function:", error);
    }
  }
  ...
  function showTooltip(e) {
    try {
      ...
      console.error("Error in showTooltip function:", error);
    }
  }
  ...
  Sparkline.prototype.draw = function (points) {
    try {
      ...
      console.error("Error in Sparkline.prototype.draw function:", error);
    }
  };
  ...
  function minmax(a, b, c) {
    try {
      ...
      console.error("Error in minmax function:", error);
    }
  }
