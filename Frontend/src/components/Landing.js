...
function Landing() {
  ...
  return (
    <div className="text-gray-800">
      ...
      <div
        id="dontMov"
        className="bg-white text-black hidden md:flex justify-between py-2 text-center text-[1.1rem] z-10 relative"
      >
        <img
          src="https://www.sscoetjalgaon.ac.in/public/images/logo/logo.jpg"
      ...
      <nav className="bg-yellow-500 border-b-2 border-red-700 text-white sticky top-0 z-50 shadow-lg w-full">
        <div className="max-w-7xl mx-auto px-4 flex items-center justify-between h-16">
          ...
          <div className="flex items-center justify-start">
            <Link
              to="/"
              className=" md:text-lg sm:text-lg font-bold hover:text-red-800"
            >
              Alumni Hub |
            </Link>
          ...
          <div className="hidden md:flex space-x-6">
            <HashLink
              to="/#home"
              className="hover:bg-red-800 text-white rounded-[15px] py-1 px-3"
            >
              Home
            </HashLink>
            <HashLink
          ...
          <div className="flex items-center justify-end">
            {isLoggedin ? (
              <Link
                to="/myprofile"
                className="hover:bg-red-900 text-white py-2 px-4 rounded-[15px]"
              >
                Dashboard
              </Link>
            ) : (
        ...
        {navOpen && (
          <div className="md:hidden bg-white text-black">
            <HashLink
              ...
              className="block hover:bg-red-800 text-white py-1 px-2"
            >
              Home
            </HashLink>
            <HashLink
      ...
      >
        ...
        <button
          onClick={prevSlide}
          className="absolute left-5 top-1/2 transform -translate-y-1/2 text-white bg-black bg-opacity-50 rounded-full p-2"
        >
          &#10094;
        </button>
        <button
          onClick={nextSlide}
          className="absolute right-5 top-1/2 transform -translate-y-1/2 text-white bg-black bg-opacity-50 rounded-full p-2"
        >
          &#10095;
        </button>
      </div>
        ...
        <div className="container mx-auto max-w-screen-xl">
          <div className="flex flex-col lg:flex-row gap-10 lg:gap-16">
            ...
            <div className="lg:w-1/2 text-center relative   lg:text-left space-y-4">
              <h2 className="text-3xl font-bold mt-5 mb-2 text-red-900">
                About Us
              </h2>
              <i>
                <p className="text-base text-gray-700 leading-relaxed">
                  Welcome to AlumniHub! We connect students, alumni, and college
                  staff to foster lasting relationships and opportunities.
                  Students can reach out to alumni for career guidance, apply
                  for internships, and access job openings. Alumni can mentor
                  students and engage in college activities, while
                  administrators manage alumni data and organize events. With
                  easy-to-use features for networking, event planning, and
                  secure donations, AlumniHub supports everyone’s journey from
                  student to proud alumni. Join us in keeping the college
